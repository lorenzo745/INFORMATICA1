...
*
* @brief Scrivere un programma che visualizzi tutte le coppie ordinate di numeri naturali la cui somma � 15. 
* 
* <specifiche del progetto>
* Scrivere un programma che visualizzi tutte le coppie ordinate di numeri naturali la cui somma � 15. 
* 
